...
<div class="navsection">
	...
	<div class="navsectionlinks">
		<ul class="navsectionlinks">
			...
			<li><a href="<?php echo $cfg["cgi_base_url"];?>/showhost.cgi" target="<?php echo $link_target;?>">Graphs</a></li>
		</ul>
	</div>
</div>
...
<div class="navsection">
	...
	<div class="navsectionlinks">
		<ul class="navsectionlinks">
			<li><a href="<?php echo $cfg["cgi_base_url"];?>/addhosts.cgi" target="<?php echo $link_target;?>">Add Host</a></li>
